...
- (void)setCurrentURLString:(NSString *)currentURLString {
    objc_setAssociatedObject(self, HMMYKEY, currentURLString,
...
- (void)setImageUrlString:(NSString *)urlString {
    ...
    if (![urlString isEqualToString:self.currentURLString]) {
        ...
        [[HMDownloaderOperationManager sharedManager]
            cancelOperation:self.currentURLString];
    }
    ...
    // 下载图片
    [[HMDownloaderOperationManager sharedManager]
        downloadWithURLString:urlString
